<?php if(time() > 1569057413){return null;} return array (
  ...
  array (
    ...
    'pagetitle' => 'GPS/GLONASS трекер Global',
    'longtitle' => '',
    'description' => '',
    'alias' => 'tracker',
    'alias_visible' => 0,
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1568371470,
    'editedby' => 0,
    'editedon' => 0,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1568371470,
    'publishedby' => 1,
    'menutitle' => 'GPS/GLONASS трекер',
    'donthit' => 0,
    'privateweb' => 0,
    'privatemgr' => 0,
    'content_dispo' => 0,
...
<head>
	...
	<title>GPS/GLONASS трекер Global</title>
...
<div class="modal fade" id="orderForm" tabindex="-1" role="dialog" aria-labelledby="orderForm" aria-hidden="true">
    ...
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="close">+</button>
        <h4 class="modal-title">Заказ устройства GPS/GLONASS трекер Global</h4>
    </div>
    <div class="modal-body">
        <div class="form-group">
			<div class="input-group">
	...
	<input type="hidden" name="af_action" value="5118ff987dd656ab238dbbd0e3792132" />
</form>
        </div>
    </div>
</div>
...
<div class="modal fade" id="testAccess" tabindex="-1" aria-labelledby="testAccess" aria-hidden="true">
    ...
    array (
      ...
      1 => '<script type="text/javascript">AjaxForm.initialize({"assetsUrl":"\\/assets\\/components\\/ajaxform\\/","actionUrl":"\\/assets\\/components\\/ajaxform\\/action.php","closeMessage":"close all","formSelector":"form.ajax_form","pageId":102});</script>',
    ),
    '_loadedjscripts' => 
    array (
      '/assets/components/ajaxform/css/default.css' => true,
      '/assets/components/ajaxform/js/default.js' => true,
      '<script type="text/javascript">AjaxForm.initialize({"assetsUrl":"\\/assets\\/components\\/ajaxform\\/","actionUrl":"\\/assets\\/components\\/ajaxform\\/action.php","closeMessage":"close all","formSelector":"form.ajax_form","pageId":102});</script>' => true,
    ),
  ),
  'contentType' => 
  array (
...
<div class="headline-bottom row">
    ...
    '[[AjaxForm? &snippet=`FormIt` &form=`RU-OrderForm-ajax` &emailTpl=`RU-OrderForm` &hooks=`email,FormItSaveForm` &submitVar=`orderFormSubmit` &emailFrom=`robot@igornesov.ru` &emailTo=`kgk.glob@yandex.ru,robot@igornesov.ru` &emailSubject=`Заказ устройства
            GPS/GLONASS трекер Global` &validate=`orderFormName:required,orderFormPhone:required,orderFormAgree:required` ]]' => '<form class="ajax-form ajax_form" name="orderForm" id="orderForm" method="post" role="form" accept-charset="UTF-8">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="close">+</button>
        <h4 class="modal-title">Заказ устройства GPS/GLONASS трекер Global</h4>
    </div>
